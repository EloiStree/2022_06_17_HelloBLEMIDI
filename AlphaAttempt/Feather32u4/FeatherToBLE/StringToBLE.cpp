...
// StringToBLEKeyboard::StringToBLEKeyboard() {}

// void StringToBLEKeyboard::Init() {
//   Keyboard.begin();
//   Keyboard.releaseAll();
// }
// void StringToBLEKeyboard::SwitchLanguageOnWindow() {
//   Keyboard.press(0x80);
//   Keyboard.press(0x81);
...
// void StringToBLEKeyboard::ConvertStringToNumpadKeys(String text) {
...
// void StringToBLEKeyboard::TryToParseTextToUnicode(String commandline) {
...
// void StringToBLEKeyboard::TryToParseTextToAction(String commandline) {
...
// void StringToBLEKeyboard::Push(uint8_t key, bool press, bool release) {
...
// }
// void StringToBLEKeyboard::Push(char key, bool press, bool release) {
...
//     Keyboard.release(key);
// }
// void StringToBLEKeyboard::PushWithDelayIfNeeded(uint8_t key, bool press, bool release, int delayMS) {
...
//   Keyboard.flush();
// }
// void StringToBLEKeyboard::PushWithDelayIfNeeded(char key, bool press, bool release, int delayMS) {
...
// void StringToBLEKeyboard::PushLearningTest() {
// }
// void StringToBLEKeyboard::ReleaseAllKey() {
